...
var I18N_DICT = {
  ...
  "banner.text": { en: "As of July 24, all patient appointments will be conducted via telemedicine while we relocate our office to better serve you.", es: "A partir del 24 de julio, todas las citas de pacientes se realizarán por telemedicina mientras reubicamos nuestra oficina para servirle mejor." },
  ...
  "banner.p2": { en: "Once our relocation is complete, we will announce the reopening of our office and begin scheduling in-person appointments.", es: "Una vez que finalice nuestra reubicación, anunciaremos la reapertura de nuestra oficina y comenzaremos a programar citas en persona." },
  "banner.p3": { en: "<strong>Important for Medicare Patients:</strong> Due to current Medicare telemedicine guidelines, Medicare patient appointments will begin on August 15. You are still encouraged to call our office now to reserve your appointment, and our team will schedule you for the earliest available appointment beginning August 15.", es: "<strong>Importante para Pacientes de Medicare:</strong> Debido a las pautas actuales de telemedicina de Medicare, las citas de pacientes de Medicare comenzarán el 15 de agosto. Aun así, le recomendamos llamar a nuestra oficina ahora para reservar su cita, y nuestro equipo le programará la cita disponible más próxima a partir del 15 de agosto." },
